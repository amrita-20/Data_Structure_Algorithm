...
public class BigNumberTest {
    ...
    public void testAddDecimal5() {
        ...
        assertEquals("0.0864", target.add(addend).toString());
    }
    ...
    @Test
    public void testMultiplyWithKaratSuba1() {
        BigNumber piSquared = BigNumber.pi.multiplyWithKaratsuba(BigNumber.pi);
        assertEquals("9.869604401089358618834490999876151135313699407240790626413349376220044822419205243001773403718552225653007487119222379933851745525268070040321103742979861060062160525374811732041221722760637532682489", piSquared.toString());
    }

    @Test
    public void testMultiplyWithKaratSuba2() {
        assertEquals(BigNumber.value(1, 21, true), BigNumber.value(1, 1, true).multiplyWithKaratsuba(BigNumber.value(1, 1, true)));
        assertEquals(BigNumber.parse("9.86960469269329"), BigNumber.value(3, 1415927, true).multiplyWithKaratsuba(BigNumber.value(3, 1415927, true)));
    }
